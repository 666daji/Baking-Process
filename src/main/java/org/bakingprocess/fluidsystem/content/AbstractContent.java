package org.bakingprocess.fluidsystem.content;

import net.minecraft.util.Identifier;
import org.bakingprocess.BakingProcess;
import org.bakingprocess.fluidsystem.registry.ContentRegistry;
...
public abstract class AbstractContent {
    ...
    protected AbstractContent(Identifier id) {
        ...
        try {
            ...
            BakingProcess.LOGGER.error("Content type registration failed: {}", id);
        }
    }
