package org.bakingprocess.fluidsystem.container;
...
import org.bakingprocess.fluidsystem.registry.ContainerRegistry;
...
public abstract class ContainerType {
    ...
    protected ContainerType(Identifier id, ContainerSettings settings) {
        ...
        try {
            ...
            BakingProcess.LOGGER.error("Container type registration failed: {}", id);
        }
    }
