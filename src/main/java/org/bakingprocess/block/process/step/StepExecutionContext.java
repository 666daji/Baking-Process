package org.bakingprocess.block.process.step;
...
import org.bakingprocess.block.process.AbstractProcess;
...
public record StepExecutionContext<T>(AbstractProcess<T> process, T blockEntity, BlockState blockState, World world,
    ...
    public BlockSoundGroup getItemSounds() {
        BlockSoundGroup group = BakingProcessUtils.getSoundGroupFromItem(getHeldItemStack());
        if (group != null) {
            return group;
        }
