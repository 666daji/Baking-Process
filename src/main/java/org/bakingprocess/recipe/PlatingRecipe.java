...
public class PlatingRecipe implements Recipe<PlatableBlockEntity> {
     ...
     * @param output 配方输出物品
     */
    public PlatingRecipe(Item container, List<PlayerAction> actions, Content output) {
    ...
    @Override
    public ItemStack assemble(PlatableBlockEntity inventory, HolderLookup.Provider registryManager) {
    ...
    public String toString() {
        return String.format("PlatingRecipe{container=%s, actions=%d, output=%s}",
                container, actions.size(), output);
    }
}