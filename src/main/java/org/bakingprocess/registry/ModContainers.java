...
public class ModContainers {
    ...
    // ????
    public static final DeferredHolder<ContainerType, ContainerType> HARD_BREAD_BOAT = register("hard_bread_boat",
    ...
    // ??
    public static final DeferredHolder<ContainerType, ContainerType> IRON_PLATE = register("iron_plate",
            () -> new DishesContainer(new ContainerType.ContainerSettings(ModItems.IRON_PLATE)
                    .setUseSound(() -> SoundEvents.BUCKET_EMPTY)));

    // ??
    public static final DeferredHolder<ContainerType, ContainerType> TOAST_EMBRYO_MOLD = register("toast_embryo_mold",
    ...
    public static final DeferredHolder<ContainerType, ContainerType> CAKE_EMBRYO_MOLD = register("cake_embryo_mold",
            () -> new MoldContainer(new ContainerType.ContainerSettings(ModItems.CAKE_EMBRYO_MOLD)
                    .setUseSound(() -> SoundEvents.SLIME_DEATH_SMALL)));

    private static DeferredHolder<ContainerType, ContainerType> register(String name, java.util.function.Supplier<ContainerType> supplier) {
